...
class Config:
    ...
    EXP_PATH = BASE_DIR / "expData" / "2024-01-04-B10n1 LowLight_JVi_#1_2.dat"
    LED_PATH = BASE_DIR / "expData" / 'LED_list.txt'
    
    fit_res_dir = RES_DIR / "fitJVi"
...
def objective(W_R, G_frac, l1_k_dir, l1_C_n_bulk, l1_mu_p):
    """
    ...
    try:
        ...
        history_data.append({
            'W_R': W_R, 'G_frac': G_frac, 'l1_k_dir': l1_k_dir,
