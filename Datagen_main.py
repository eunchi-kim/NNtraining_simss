...
dataset_name = "20260223_two_defects"
...
for bb in range(num_batches):
    ...
    with h5py.File(h5py_filename, 'w') as hf:
        ...
        hf.create_dataset("log_indices", data=np.array(log_indices))
        hf.create_dataset("log_transform_items", data=np.array(log_transform_items))
